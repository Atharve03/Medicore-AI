...
// All 15 backend business modules are now mounted. Analytics (Phase 23),
// MCP servers (Phase 21), and AI integration (Phase 22) add routes later;
// Phases 16-20 build the frontend against this API surface.
