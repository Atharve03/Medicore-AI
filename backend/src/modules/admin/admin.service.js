 ...
 *
 * isEmailVerified is set true immediately here — an admin directly
 * provisioning an account is a different trust model than public
 * self-registration, so there's no registration-OTP step to skip through.
